...
namespace Core.Migrations
{
    ...
    [Migration("20210531160521_MovieDirectorAndRuntime")]
    partial class MovieDirectorAndRuntime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Data.Models.RecommendationRequestDao", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");

                    b.Property<int>("TopRatedRecommendationPage")
                        .HasColumnType("int");

                    b.HasKey("UserId");

                    b.ToTable("RecommendationRequestDao");
                });
            ...
            modelBuilder.Entity("Core.Domain.Recommendations.Models.ReviewRecommendation", b =>
                {
                    ...
                    b.Property<long>("MovieTmdbId")
                        .HasColumnType("bigint");

                    b.Property<int>("NumberOfPagesShown")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReviewRecommendation");
                });
            ...
            modelBuilder.Entity("Core.Data.Models.RecommendationRequestDao", b =>
                {
                    b.HasOne("Core.Data.Models.UserDao", null)
                        .WithOne()
                        .HasForeignKey("Core.Data.Models.RecommendationRequestDao", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Core.Domain.Recommendations.Models.ReviewRecommendation", b =>
                {
                    b.HasOne("Core.Data.Models.ReviewDao", null)
                        .WithOne()
                        .HasForeignKey("Core.Domain.Recommendations.Models.ReviewRecommendation", "ReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Data.Models.RecommendationRequestDao", null)
